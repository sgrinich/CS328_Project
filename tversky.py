...
character_index = getobjectIndexFromName('Rosa Parks', object_names)
...
print("Top 5 Tversky:")
for i in range(5):
    print(top_tversky[i][0] + ": " + str(top_tversky[i][1]))
print

print("Top 5 Shepard:")
for i in range(5):
    print(top_shepard[i][0] + ": " + str(top_shepard[i][1]))
print 

print("Top 5 Medin:")
for i in range(5):
    print(top_medin[i][0] + ": " + str(top_medin[i][1]))